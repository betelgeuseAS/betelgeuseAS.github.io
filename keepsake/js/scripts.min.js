...
$(function(){var i=$(".preloader"),o=i.find(".preloader__content_svg");$(window).on("load",function(){o.fadeOut(),i.delay(500).fadeOut("slow")}),$(".list li").click(function(){$(".list li").removeClass("active"),$(this).addClass("active")});mixitup(".Works_portfolio",{});$(".popup_content").magnificPopup({type:"inline",midClick:!0}),$(".portfolio_item").each(function(i){$(this).find("a").attr("href","#work_"+i),$(this).find(".portfolio_description").attr("id","work_"+i)}),$(".popupForm").magnificPopup(),$(".header_menu a, .top").mPageScroll2id({offset:100,scrollSpeed:1e3}),(new WOW).init({mobile:!1})});